...
create table if not exists public.members (
  ...
  access_level text not null default 'member' check (
    access_level in ('couple_coordinator', 'area_servant', 'lit_servant', 'chapter_servant', 'member')
  ),
...
create table if not exists public.profiles (
  ...
  role text not null default 'member' check (
    role in ('couple_coordinator', 'area_servant', 'lit_servant', 'chapter_servant', 'member')
  ),
