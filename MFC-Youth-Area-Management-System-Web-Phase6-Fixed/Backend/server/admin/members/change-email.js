...
export default async function handler(req, res) {
  ...
  try {
    ...
    return sendJson(res, 200, {
      ...
      message: syncError
        ? 'Auth email was updated. Member email synchronization is pending and will retry on the next authenticated request.'
        : 'Account email has been successfully overridden.'
    });
