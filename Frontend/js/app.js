...
// CSP-safe event delegation for actions rendered through innerHTML.
// Keeping action code in this trusted external script lets us retain a strict
// Content-Security-Policy without relying on blocked inline onclick handlers.
document.addEventListener('click', event => {
  ...
  try {
    switch (action) {
      case 'view-member':
        result = window.viewMember?.(id);
        break;
      case 'edit-member':
        result = window.editMember?.(id);
        break;
      case 'service-member':
        result = window.serviceMember?.(id);
        break;
      case 'gig-member':
        result = window.gigMember?.(id);
        break;
      case 'manage-member-login':
        result = window.manageMemberLogin?.(id);
        break;
      case 'delete-member':
        result = window.deleteMember?.(id);
        break;
      case 'delete-gig-contribution':
        result = window.deleteGigContribution?.(
          trigger.dataset.memberId,
          trigger.dataset.contributionId
        );
        break;
      case 'view-chapter':
        result = window.viewChapter?.(id);
        break;
      case 'add-members-to-chapter':
        result = window.addMembersToChapter?.(id);
        break;
      case 'edit-chapter':
        result = window.editChapter?.(id);
        break;
      case 'delete-chapter':
        result = window.deleteChapter?.(id);
        break;
      case 'view-service':
        result = window.viewService?.(trigger.dataset.service || '');
        break;
      case 'edit-report':
        result = window.reportModal?.(id);
        break;
      case 'delete-report':
        result = window.deleteReport?.(id);
        break;
      case 'view-event':
        result = window.viewEvent?.(id);
        break;
      case 'edit-event':
        result = window.eventModal?.(id);
        break;
      case 'delete-event':
        result = window.deleteEvent?.(id);
        break;
      case 'edit-participant':
        result = window.participantModal?.(
          trigger.dataset.eventId,
          trigger.dataset.participantId
        );
        break;
      case 'delete-participant':
        result = window.deleteParticipant?.(
          trigger.dataset.eventId,
          trigger.dataset.participantId
        );
        break;
      case 'register-participant':
        result = window.participantModal?.(trigger.dataset.eventId);
        break;
      default:
        return;
    }
              ...
              ${list.map(member => `
                <tr>
                  ...
                  <td class="actions-cell">
                    <button class="btn" type="button" data-app-action="view-member" data-id="${esc(member.id)}">View</button>
                  </td>
                </tr>
              `).join('')}
            </tbody>
            ...
            '—'
              ...
              '—'
                        ...
                        >
                          <button
                            class="btn"
                            data-app-action="view-member" data-id="${esc(member.id)}"
                           type="button">
                            View
                          </button>
                          ...
                          <button
                            class="btn"
                            data-app-action="edit-member" data-id="${esc(member.id)}"
                           type="button">
                            Edit
                          </button>
                          ...
                          <button
                            class="btn"
                            data-app-action="service-member" data-id="${esc(member.id)}"
                           type="button">
                            Services
                          </button>
                          ...
                          <button
                            class="btn"
                            data-app-action="gig-member" data-id="${esc(member.id)}"
                           type="button">
                            GIG
                          </button>
                          ...
                          <button
                            ...
                            data-app-action="manage-member-login" data-id="${esc(member.id)}"
                           type="button">
                          ...
                          ${isOwnMemberRecord(member)
                            ...
                            : `
                              <button
                                class="btn red"
                                data-app-action="delete-member" data-id="${esc(member.id)}"
                               type="button">
                                Delete
                              </button>
                            `}
          ...
          row => `
            ...
            row.amount
                    ...
                    <button
                      class="mini-delete"
                      type="button"
                      data-app-action="delete-gig-contribution" data-member-id="${esc(id)}" data-contribution-id="${esc(row.id)}"
                  ...
                  ${members.map(member => {
                    ...
                    return `
                      <tr>
                        ...
                        <td class="actions-cell">
                          <button class="btn" type="button" data-app-action="view-member" data-id="${esc(member.id)}">View</button>
                          <button class="btn" data-app-action="gig-member" data-id="${esc(member.id)}" type="button">GIG</button>
                        </td>
                      </tr>
                    `;
                  }).join('')}
              ...
              member =>
                ...
                'Active'
                          ...
                          >
                            <button
                              class="btn"
                              data-app-action="view-chapter" data-id="${esc(chapter.id)}"
                             type="button">
                              View Members
                            </button>
                            ...
                            <button
                              class="btn"
                              data-app-action="add-members-to-chapter" data-id="${esc(chapter.id)}"
                             type="button">
                              + Add Members
                            </button>
                            ...
                            <button
                              class="btn"
                              data-app-action="edit-chapter" data-id="${esc(chapter.id)}"
                             type="button">
                              Rename
                            </button>
                            ...
                            <button
                              class="btn red"
                              data-app-action="delete-chapter" data-id="${esc(chapter.id)}"
                             type="button">
                              Delete
                            </button>
                          </td>
      ...
      .map(service => {
        ...
        return `
            ...
            : 's'
              ...
              <button
                class="btn"
                data-app-action="view-service" data-service="${esc(service)}"
               type="button">
                View Members
              </button>
          ...
          report => `
            ...
            '—'
                        ...
                        >
                          <button
                            class="btn"
                            data-app-action="edit-report" data-id="${esc(report.id)}"
                           type="button">
                            Edit
                          </button>
                          ...
                          <button
                            class="btn red"
                            data-app-action="delete-report" data-id="${esc(report.id)}"
                           type="button">
                            Delete
                          </button>
                        </td>
              ...
              '—'
                ...
                event
                          ...
                          >
                            <button
                              class="btn"
                              data-app-action="view-event" data-id="${esc(event.id)}"
                             type="button">
                              View
                            </button>
                            ...
                            ${canManage
                              ? `
                                <button
                                  class="btn"
                                  data-app-action="edit-event" data-id="${esc(event.id)}"
                                 type="button">
                                  Edit
                                </button>
                                ...
                                <button
                                  class="btn red"
                                  data-app-action="delete-event" data-id="${esc(event.id)}"
                                 type="button">
                                  Delete
                                </button>
                              `
                      ...
                      >
                        ${canManage
                          ? `
                            <button
                              class="btn"
                              data-app-action="edit-participant" data-event-id="${esc(id)}" data-participant-id="${esc(participant.id)}"
                             type="button">
                              Edit
                            </button>
                            ...
                            <button
                              class="btn red"
                              data-app-action="delete-participant" data-event-id="${esc(id)}" data-participant-id="${esc(participant.id)}"
                             type="button">
                              Delete
                            </button>
                          `
      ...
      ${canManage
        ? `
          <button
            class="btn blue"
            type="button"
            data-app-action="register-participant" data-event-id="${esc(id)}"
          >
